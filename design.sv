// =============================================================================
// design.sv — All RTL modules merged for EDA Playground
// Submodules must appear BEFORE rv32i_top (the top-level instantiator)
// =============================================================================
...
// BUG FIX: id_branch / ex_branch changed from [4:0] to 1-bit
// -----------------------------------------------------------------------------
module pipe_id_ex (
